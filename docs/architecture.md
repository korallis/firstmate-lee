...
Cursor SDK support currently stops at the shell-callable bridge in `docs/cursor-sdk-backend.md`; it is not selectable as a runtime backend until an adapter is implemented and verified.
